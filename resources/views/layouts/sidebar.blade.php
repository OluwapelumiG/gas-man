...
{{--            </div>--}}
    ...
    <div class= "max hidden text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]">
        ...
        <div class =  "w-full text-white bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3
        hover:ml-4 hover:text-purple-500 dark:hover:text-blue-500
        {{ (Route::currentRouteName() == 'dashboard') ? 'ml-4 text-purple-500 dark:text-blue-500' : '' }}">
        ...
        <div class =  "w-full text-white bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3
        hover:ml-4 hover:text-purple-500 dark:hover:text-blue-500
        {{ (Route::currentRouteName() == 'users') ? 'ml-4 text-purple-500 dark:text-blue-500' : '' }}">
        ...
        <div class =  "w-full text-white bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3
        hover:ml-4 hover:text-purple-500 dark:hover:text-blue-500
        {{ (Route::currentRouteName() == 'sales') ? 'ml-4 text-purple-500 dark:text-blue-500' : '' }}">
